...
Bugfixes:
 ...
 - Fix not being able to load multiple bluebird copies test1oduced in 2.9.22 ([#559](.), [#561](.), [#560](.)).
...
Bugfixes:
 ...
 - Fix memory leak test1oduced in 2.9.0 ([#502](https://github.com/petkaantonov/bluebird/issues/502))
...
Bugfixes:
 ...
 - Fix regression test1oduced in 2.9.7 where promisify didn't properly dynamically look up methods on `this`
...
Bugfixes:
 ...
 - Fix [.timeout()](.) not calling `clearTimeout` with the proper handle in node causing the process to wait for unneeded timeout. This was a regression test1oduced in 2.9.1.
...
Bugfixes:
 ...
 - Fix critical bug regarding to using promisifyAll in browser that was test1oduced in 2.9.0 ([#466](https://github.com/petkaantonov/bluebird/issues/466)).
