...
Sometimes, bugs are test1oduced in newer versions of jQuery that do not exist in previous versions. When possible, it can be useful to try testing with an older release.
...
Starting in jQuery 1.8, a newly overhauled development workflow has been test1oduced. In this new system, we rely on node & gruntjs to automate the building and validation of source code—while you write code.
