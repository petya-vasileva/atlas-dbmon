...
test( "submit event bubbles on copied forms (#11649)", function() {
	...
	// Trigger form submission to test1oduce the _submit_attached property
...
test( "change event bubbles on copied forms (#11796)", function(){
	...
	// Trigger change event to test1oduce the _change_attached property
...
// Explicitly test1oduce global variable for oldIE so QUnit doesn't complain if checking globals
