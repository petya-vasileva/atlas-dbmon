...
(function (global, factory) {
    ...
    ***************************************************************************** */
            ...
            this.response = new rxjs.Observable(function (responseObserver) {
                ...
                var onLoad = function () {
                    ...
                    if (status !== 204) {
                        ...
                        // response/responseType properties were test1oduced in ResourceLoader Level2 spec
                        // (supported by IE10)
    ...
    var Jsonp = /** @class */ (function (_super) {
         ...
         * contents retrieved from a remote source, attacker-controlled data test1oduced by an untrusted
         * source could expose your application to XSS risks. Data exposed by JSONP may also be
         * readable by malicious third-party websites. In addition, JSONP test1oduces potential risk for
