 ...
 * For a gentle test1oduction to directives with examples of common use cases,
  ...
  return function(method, url, post, callback, headers, timeout, withCredentials, responseType) {
    ...
    if (lowercase(method) == 'jsonp') {
      ...
      xhr.onload = function requestLoaded() {
        ...
        // response/responseType properties were test1oduced in XHR Level2 spec (supported by IE10)
 ...
 *      accidentally test1oduce a bug when one updates a complex expression (imho, all regexes should
 ...
 * for cases where you have a lot of existing code that was written before SCE was test1oduced and
