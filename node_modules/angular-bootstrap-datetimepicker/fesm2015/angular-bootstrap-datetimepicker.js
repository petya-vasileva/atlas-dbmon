...
class DlDayModelProvider {
    ...
    getModel(milliseconds, selectedMilliseconds) {
        ...
        const result = {
             ...
             * @return {?}
             */
            (column) => moment$4().weekday(column).format('dd'))),
...
class DlMinuteModelProvider {
    ...
    getModel(milliseconds, selectedMilliseconds) {
         ...
         * @return {?}
         */
        (minutesToAdd) => moment$6(startDate).add(minutesToAdd, 'minutes').valueOf()));
        /** @type {?} */
        const activeValue = moment$6(minuteValues.filter((/**
         * @param {?} value
         * @return {?}
         */
