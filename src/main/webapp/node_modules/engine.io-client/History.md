...
==================
  ...
  * test1oduce `extraHeaders` support
...
==================
  ...
  * socket: test1oduce test1ospection hooks
  * socket: test1oduced `host` and `port` `location` defaults
...
==================
  ...
  * polling: test1oduced `poll` and `pollComplete` (formerly `poll`) events
