...
- ([4776c16](https://github.com/angular/jasminewd/commit/4776c16b9a9f3a9a3de8a8dddc0e051cb32331b4))
  ...
  Update selenium-webdriver to 2.47.0 from 2.45.1. This update test1oduces a convoluted situation
  ...
  `flow.execute` wrapper around `expect` calls. This appears not to test1oduce any issues to existing
  tests.
