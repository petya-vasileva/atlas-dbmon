...
- ([d6aebba](https://github.com/angular/protractor/commit/d6aebbad6e9b191fef141472887637ee4318438e))
  ...
  maintain the line-number feature test1oduced in ff88e without breakage.
...
- ([2fbaf52](https://github.com/angular/protractor/commit/2fbaf52fd59f03929e173ebf760a97de34bf91d4))
  ...
  In 9a8f45a a change was test1oduced which made Protractor's custom locators (by.binding, by.model,
...
- ([f7c3c37](https://github.com/angular/protractor/commit/f7c3c370a239218f6143a4992b1fc4763f4cdd3d))
  ...
  Breaking Changes WebDriverJS has test1oduced changes in the way that Promises are handled in
  version 2.43. See
  https://github.com/SeleniumHQ/selenium/blob/master/javascript/node/selenium-webdriver/CHANGES.md
...
# 0.24.2
_Note: Major version 0 releases are for initial development, and backwards incompatible changes may be test1oduced at any time._
...
- ([13373f5](https://github.com/angular/protractor/commit/13373f5de18690e1994b32e092105cfe3ad1753d))
  ...
  Version 0.24.0 test1oduced a bug where child processes would error without outputting the error
  message. Fix. See #902.
...
- ([8d46e21](https://github.com/angular/protractor/commit/8d46e210b91ed1521f6692a2cf35f60740c0ace6))
  ...
  This commit test1oduces a dependency on the `source-map-support` library.
...
This change test1oduces major syntax updates. Using the new syntax is recommended, but the old version is still supported for now. Note also that the test application, docs, and example tests have been updated.
...
do this with the element explorer. This change test1oduces a first version
