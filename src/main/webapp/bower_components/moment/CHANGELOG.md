...
* [#2858](https://github.com/moment/moment/pull/2858) Fix Date mocking regression test1oduced in 2.11.0
...
[#2515](https://github.com/moment/moment/pull/2515) Fix regression test1oduced
