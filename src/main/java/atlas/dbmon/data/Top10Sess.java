 ...
 *
 */
public class Top10Sess implements java.io.Serializable {
	...
	public Top10Sess(Integer instId, String chartType, String parsingSchema, String name, float y, String metricUnit, String sqlText) {
		super();
		this.instId = instId;
