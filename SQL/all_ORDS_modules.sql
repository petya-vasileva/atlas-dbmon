...
-- Schema: DBMON_SCHEMA   Date: Wed Sep 05 14:11:39 CEST 2018
--
BEGIN
  ORDS.ENABLE_SCHEMA(
      p_enabled             => TRUE,
...
'SELECT schema_name FROM TABLE(DBMON_SCHEMA.GET_ALL_SCHEMAS(:db))'
  ...
  ORDS.DEFINE_HANDLER(
      ...
      p_comments       => NULL,
      p_source         => 
'SELECT schema_name FROM TABLE(DBMON_SCHEMA.GET_ALL_SCHEMAS(:db)) WHERE schema_name <> ''ALL'''
      );
...
order by message_ts desc'
  ...
  ORDS.DEFINE_HANDLER(
      ...
      p_comments       => NULL,
      p_source         => 
'SELECT source, apply_lag, snapshot_time, status, :db as dbname FROM TABLE(DBMON_SCHEMA.GET_APPLY_LAG(:db))'
      );
...
FROM TABLE(DBMON_SCHEMA.GET_JOBS_INFO(:db, :schema))'
      );
  ...
  ORDS.DEFINE_HANDLER(
      ...
      p_comments       => NULL,
      p_source         => 
'select * from table(DBMON_SCHEMA.GET_DB_UP_STATUS(:db))'
      );
  ...
  ORDS.DEFINE_HANDLER(
      ...
      p_comments       => NULL,
      p_source         => 
'select * from table(DBMON_SCHEMA.GET_EXP_PLAN_DATA(:sqlid, :db))'
      );
...
from table(DBMON_SCHEMA.GET_TOP10_SESSIONS_DATA(:db, :fromDate, :toDate))'
  ...
  ORDS.DEFINE_MODULE(
      p_module_name    => 'top10_tables',
      p_base_path      => '/top10_tables/',
      p_items_per_page =>  0,
      p_status         => 'PUBLISHED',
      p_comments       => NULL);      
  ORDS.DEFINE_TEMPLATE(
  ...
  ORDS.DEFINE_HANDLER(
      ...
      p_source         => 
'SELECT * 
FROM TABLE(DBMON_SCHEMA.GET_TOP10_TABLES_PER_SCHEMA(:db, :schema, :year)) order by OBJECT_NAME, OBJECT_TYPE, DT'
      );
