...
-- Schema: ATLAS_DBMON   Date: Wed Sep 05 14:11:39 CEST 2018
--
BEGIN
  ORDS.ENABLE_SCHEMA(
      p_enabled             => TRUE,
...
from table(ATLAS_DBMON.GET_TOP10_SESSIONS_DATA(:db, :fromDate, :toDate))'
  ...
  ORDS.DEFINE_HANDLER(
      ...
      p_source         => 
'SELECT * 
FROM TABLE(ATLAS_DBMON.GET_TOP10_TABLES_PER_SCHEMA(:db, :schema, :year)) order by OBJECT_NAME, OBJECT_TYPE, DT'
      );
